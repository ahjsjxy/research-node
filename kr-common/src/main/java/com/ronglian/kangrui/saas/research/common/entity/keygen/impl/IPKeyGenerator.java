package com.ronglian.kangrui.saas.research.common.entity.keygen.impl;


import com.ronglian.kangrui.saas.research.common.entity.keygen.KeyGenerator;
import com.ronglian.kangrui.saas.research.common.entity.keygen.DefaultKeyGenerator;
...
public final class IPKeyGenerator implements KeyGenerator {
    ...
    public static void main(String[] args) {
         IPKeyGenerator ipKeyGenerator = new IPKeyGenerator();
        Number number = ipKeyGenerator.generateKey();
