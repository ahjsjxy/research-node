...
@Table(name = "disease_field")
public class DiseaseField implements Serializable {
    @Id
     ...
     * 获取疾病id （疾病表的主键id）
     *
     * @return disease_id - 疾病id （疾病表的主键id）
     */
    ...
    public boolean equals(Object that) {
        ...
        DiseaseField other = (DiseaseField) that;
