...
public class StudyGroup implements Serializable {
     ...
     * 设置入组条件
     *
     * @param entryCondition 入组条件
     */
    public void setEntryCondition(String entryCondition) {
        this.entryCondition = entryCondition == null ? null : entryCondition.trim();
    }

    /**
     * 获取排除条件
     *
     * @return exclude_condition - 排除条件
     */
    ...
    public void setExcludeCondition(String excludeCondition) {
        this.excludeCondition = excludeCondition == null ? null : excludeCondition.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        StudyGroup other = (StudyGroup) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getStudyId() == null ? other.getStudyId() == null : this.getStudyId().equals(other.getStudyId()))
            && (this.getName() == null ? other.getName() == null : this.getName().equals(other.getName()))
            && (this.getEntryCondition() == null ? other.getEntryCondition() == null : this.getEntryCondition().equals(other.getEntryCondition()))
            && (this.getExcludeCondition() == null ? other.getExcludeCondition() == null : this.getExcludeCondition().equals(other.getExcludeCondition()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getEntryCondition() == null) ? 0 : getEntryCondition().hashCode());
        result = prime * result + ((getExcludeCondition() == null) ? 0 : getExcludeCondition().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", entryCondition=").append(entryCondition);
        sb.append(", excludeCondition=").append(excludeCondition);
