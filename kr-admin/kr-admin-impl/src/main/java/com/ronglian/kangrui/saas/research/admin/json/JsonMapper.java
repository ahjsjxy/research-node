package com.ronglian.kangrui.saas.research.admin.json;
...
/**
 * 把空值，空数组转为 空字符串和空数组
 * 参考 https://blog.csdn.net/chenyongtu110/article/details/78488122
 */
public class JsonMapper extends ObjectMapper {
    ...
    public JsonMapper(Include include) {
        ...
        // 允许单引号、允许不带引号的字段名称
        this.enableSimple();
        // 设置输入时忽略在JSON字符串中存在但Java对象实际没有的属性  禁止遇到未知（新）属性时报错，支持兼容扩展
