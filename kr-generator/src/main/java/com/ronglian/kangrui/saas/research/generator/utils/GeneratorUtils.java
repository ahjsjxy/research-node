package com.ronglian.kangrui.saas.research.generator.utils;

import com.ronglian.kangrui.saas.research.generator.entity.ColumnEntity;
import com.ronglian.kangrui.saas.research.generator.entity.TableEntity;
...
//        templates.add("template/service.impl.java.vm");
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("biz.java.vm")) {
            return packagePath + "impl" + File.separator  + "biz" + File.separator + className + "Biz.java";
        }
        if (template.contains("mapper.java.vm")) {
            return packagePath + "impl" + File.separator  + "mapper" + File.separator + className + "Mapper.java";
        }
        if (template.contains("entity.java.vm")) {
            return packagePath + "impl" + File.separator  + "entity" + File.separator + className + ".java";
        }
        if (template.contains("api.java.vm")) {
            return packagePath + "impl" + File.separator  + "rpc" + File.separator + className + "Api.java";
        }
        if (template.contains("manager.java.vm")) {
            return packagePath + "impl" + File.separator  + "manager" + File.separator + className + "Manager.java";
        }
        if (template.contains("manager.intf.java.vm")) {
            return packagePath + "intf" + File.separator  + "api" + File.separator + "I" + className + "Service.java";
        }
        if (template.contains("manager.impl.java.vm")) {
            return packagePath + "impl" + File.separator  + "api" + File.separator + className + "Service.java";
        }
